...
class SegCNN(model.Model):
    ...
    def  _get_outputs(self, inputs, input_seq_length, is_training):
        ...
        with tf.variable_scope(self.scope):
            ...
            primary_caps = layer.EncDecCNN(kernel_size=(5,5), num_filters=16, strides=(2,2), padding='SAME',
                                             name='primarycaps')(conv1)

            # Layer 2: Convolutional Capsule
            conv_cap_2_1 = layer.EncDecCNN(kernel_size=(5,5), num_filters=32, strides=(1,1), padding='SAME',
                                               name='conv_cap_2_1')(primary_caps)

            # Layer 2: Convolutional Capsule
            conv_cap_2_2 = layer.EncDecCNN(kernel_size=(5,5), num_filters=32, strides=(2,2), padding='SAME',
                                               name='conv_cap_2_2')(conv_cap_2_1)

            # Layer 3: Convolutional Capsule
            conv_cap_3_1 = layer.EncDecCNN(kernel_size=(5,5), num_filters=64, strides=(1,1), padding='SAME',
                                               name='conv_cap_3_1')(conv_cap_2_2)

            # Layer 3: Convolutional Capsule
            conv_cap_3_2 = layer.EncDecCNN(kernel_size=(5,5), num_filters=192, strides=(2,2), padding='SAME',
                                               name='conv_cap_3_2')(conv_cap_3_1)

            # Layer 4: Convolutional Capsule
            conv_cap_4_1 = layer.EncDecCNN(kernel_size=(5,5), num_filters=128, strides=(1,1), padding='SAME',
            ...
            deconv_cap_1_1 = layer.EncDecCNN(kernel_size=(4,4), num_filters=64, transpose=True,
            ...
            # Layer 1 Up: Deconvolutional Capsule
            deconv_cap_1_2 = layer.EncDecCNN(kernel_size=(5,5), num_filters=64, strides=(1,1),
            ...
            deconv_cap_2_1 = layer.EncDecCNN(kernel_size=(4,4), num_filters=32, transpose=True,
                                                 strides=(2, 2), padding='SAME',
            ...
            # Layer 2 Up: Deconvolutional Capsule
            deconv_cap_2_2 = layer.EncDecCNN(kernel_size=(5,5), num_filters=16, strides=(1,1),
                                              padding='SAME', name='deconv_cap_2_2')(up_2)

            # Layer 3 Up: Deconvolutional Capsule
            t_out = tf.shape(conv1)[1]
            freq_out = conv1.shape[2]
            deconv_cap_3_1 = layer.EncDecCNN(kernel_size=(4,4), num_filters=16, transpose=True,
                                                 strides=(2, 2), padding='SAME',
