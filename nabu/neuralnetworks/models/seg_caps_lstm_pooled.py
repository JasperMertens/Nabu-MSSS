...
class SegCapsLSTMPooled(model.Model):
    ...
    def  _get_outputs(self, inputs, input_seq_length, is_training):
        ...
        with tf.variable_scope(self.scope):
            ...
            primary_caps = layer.EncDecCapsulePooled(kernel_size=kernel_size, num_capsules=num_capsules_lst[0], capsule_dim=capsule_dim_lst[0],
                                               pool_filter=(2,2), padding='SAME',
            ...
            if f_reduction_rate == 1:
                pool_filter[1] = 2
            conv_cap_2_2 = layer.EncDecCapsulePooled(kernel_size=kernel_size, num_capsules=num_capsules_lst[2], capsule_dim=capsule_dim_lst[2],
                                                     pool_filter=pool_filter, padding='SAME',
            ...
            # Layer 3: Convolutional Capsule
            conv_cap_3_2 = layer.EncDecCapsulePooled(kernel_size=kernel_size, num_capsules=num_capsules_lst[4], capsule_dim=capsule_dim_lst[4],
                                                     pool_filter=(2,2), padding='SAME',
